<?php
  if(isset($_POST['submit'])){
    if(trim($_POST['exampleInputName']) == ''){
      $haserror = true;
    }else{
      $name = trim($_POST['exampleInputName']);
    }
    if(trim($_POST['exampleInputEmail']) == ''){
      $haserror = true;
    }else{
      $email = trim($_POST['exampleInputEmail']);
    }
    if(!isset($haserror)){
      $emailTo = '170107031@stu.sdu.edu.kz';
      $body = "Name: $name \n\nEmail:\n $email";
...
<body id="topnav">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        ...
        <ul class="navbar-nav nav-flex-icons">
          ...
          <li class="nav-item">
              <a href="cart.php" class="nav-link waves-effect" name="logout">
                Log Out
              </a>
          </li>
  ...
  <footer class="page-footer blue accent-4 text-center font-small mt-4 wow fadeIn">
    <div class="pt-4 border-b">
      ...
      <a href="#" role="button" class="btn btn-outline-white" data-toggle="modal" data-target="#exampleModalLong">FeedBack
      <i class="fa fa-graduation-cap ml-2"></i></a>
    </div>
    <hr class="my-4">
    <div class="pb-4">
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-primary" id="exampleModalLongTitle">FeedBack</h5>
          ...
          <div class="modal-body">
            <div class="container-fluid">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-lg" id="exampleInputName" placeholder="Text" name="exampleInputName" required>
                  <small class="form-text text-muted" id="nameHelp">Enter your Name & Surname</small>
                </div>
